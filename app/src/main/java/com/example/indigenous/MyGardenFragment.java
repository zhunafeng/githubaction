...
import com.example.indigenous.databinding.FragmentMyGardenBinding;
...
public class MyGardenFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        FragmentMyGardenBinding binding = FragmentMyGardenBinding.inflate(inflater,container,false);
        binding.setLifecycleOwner(this);
        MyGardenListViewModel model = new MyGardenListViewModel(new GardeningPlantRepository(AppDatabase.getInstance(getContext()).getGardeningPlantDao()));
